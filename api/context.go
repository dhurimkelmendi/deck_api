...
const (
	CtxSerializeDeck ErrorContext = "ctxSerializeDeck"
)

// Deck error contexts
const (
	CtxGetDeck          ErrorContext = "ctxGetDeck"
	CtxCreateDeck       ErrorContext = "ctxCreateDeck"
	CtxDrawCardFromDeck ErrorContext = "ctxDrawCardFromDeck"
)
