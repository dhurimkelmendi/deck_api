...
var (
	...
	// Deck errors
	ErrGetDeck          = NewResponseError("errFindDeck", "unable to get deck")
	ErrDeckNotFound     = NewResponseError("errDeckNotFound", "deck not found")
	ErrCreateDeck       = NewResponseError("errCreateDeck", "unable to create deck")
	ErrDrawCardFromDeck = NewResponseError("errDrawCardFromDeck", "unable to draw card from deck")
)
