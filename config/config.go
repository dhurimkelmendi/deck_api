...
func (c *Config) readConfigs() {
	...
	c.DatabaseName = appConfig.GetConfig("DB_NAME", "deck_api_db")
	c.DatabaseUsername = appConfig.GetConfig("DB_USERNAME", "postgres")
	c.DatabasePassword = appConfig.GetConfig("DB_PASSWORD", "")
